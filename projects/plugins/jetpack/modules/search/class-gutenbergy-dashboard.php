 ...
 */
class Gutenbergy_Dashboard {
	/**
	 * The singleton instance of this class.
	 *
	 * @var Gutenbergy_Dashboard
	 */
	...
	public static function instance() {
		if ( ! isset( self::$instance ) ) {
			self::$instance = new Gutenbergy_Dashboard();
	...
	public function load_admin_styles() {
		...
		wp_enqueue_style(
			'jp-search-customize',
			plugins_url( '_inc/build/search-customization.css', JETPACK__PLUGIN_FILE ),
			array(
				'wp-components',
			),
			JETPACK__VERSION
	...
	public function load_admin_scripts() {
		$script_deps_path    = JETPACK__PLUGIN_DIR . '_inc/build/search-customization.asset.php';
		...
		wp_enqueue_script(
			...
			plugins_url( '_inc/build/search-customization.js', JETPACK__PLUGIN_FILE ),
			$script_dependencies,
			JETPACK__VERSION,
			true
		);
