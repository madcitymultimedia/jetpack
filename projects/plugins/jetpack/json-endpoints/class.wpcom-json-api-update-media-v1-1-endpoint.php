...
new WPCOM_JSON_API_Update_Media_v1_1_Endpoint(
	array(
		...
		'request_format'       => array(
			...
			'display_embed' => '(int) Video only. Whether to share or not the video.',
...
class WPCOM_JSON_API_Update_Media_v1_1_Endpoint extends WPCOM_JSON_API_Endpoint {
	function callback( $path = '', $blog_id = 0, $media_id = 0 ) {
		...
		if ( 'video/videopress' === $item->mime_type ) {
			$result = $this->persist_video_meta( $media_id, $input );
	 ...
	 */
	public function persist_video_meta( $media_id, $input ) {
